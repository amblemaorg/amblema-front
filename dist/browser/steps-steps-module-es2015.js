...
/* harmony import */ var _raw_loader_steps_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./steps.component.html */ "sOvX");
/* harmony import */ var _steps_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./steps.component.scss */ "wx8+");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _ngxs_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ngxs/store */ "e1JD");
/* harmony import */ var _services_steps_steps_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../services/steps/steps.service */ "OR82");
/* harmony import */ var _store_states_e_learning_user_state__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../store/states/e-learning/user.state */ "HQy9");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs */ "qCKp");
/* harmony import */ var _store_actions_steps_project_actions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../store/actions/steps/project.actions */ "/J+G");
/* harmony import */ var _store_states_steps_project_state__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../store/states/steps/project.state */ "04Jp");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/router */ "iInd");
/* harmony import */ var _general_steps_general_steps_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./general-steps/general-steps.component */ "r9gT");
/* harmony import */ var src_app_store_actions_e_learning_learning_modules_actions__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/store/actions/e-learning/learning-modules.actions */ "sy2/");
...
let StepsComponent = class StepsComponent {
    constructor(stepsService, store, route, router) {
    ...
    ngOnInit() {
        if (!this.munsLoaded)
            this.subscription.add(this.stepsService.getMunicipalities().subscribe(({ records: res }) => {
        ...
        this.subscription.add(this.stepsService.enableTab.subscribe((res) => {
            this.enabledTabs = res;
        }));
        this.subscription.add(this.stepsService.goToMods.subscribe((res) => {
            this.goToModules();
        }));
        if (!this.isTest) {
            this.subscription.add(this.selected_project_id$.subscribe((res) => {
                if (res) {
                    this.project_id = res;
                    if (!this.stepsService.areStepsCalled()) {
                        this.fetchingSteps = true;
                        this.subscription.add(this.store
                            .dispatch(new _store_actions_steps_project_actions__WEBPACK_IMPORTED_MODULE_8__["UpdateStepsProgress"](this.project_id))
                            .subscribe((res) => {
                            this.stepsService.callSteps(true);
                            this.enabledTabs = true;
                            this.fetchingSteps = false;
                        }));
                        this.store.dispatch(new src_app_store_actions_e_learning_learning_modules_actions__WEBPACK_IMPORTED_MODULE_12__["UpdateModulesTotal"]());
                    }
                }
            }));
            this.subscription.add(this.user_id$.subscribe((res) => {
                if (res)
                    this.user_id = res;
            }));
            this.subscription.add(this.user_type$.subscribe((res) => {
                if (res)
                    this.user_type = res;
            }));
            this.subscription.add(this.project_steps$.subscribe((res) => {
                if (res.steps.length > 0) {
                    ...
                    res.steps.forEach((record) => {
                        let step_ = Object.assign(Object.assign({}, record), { checklist: this.getChecks(record.checklist), sending: false });
                        ...
                        if (stepRequireApproval && stepIsNotApproved) {
                            ...
                            if (approvalHistory.length > 0) {
                                ...
                                step_ = Object.assign(Object.assign({}, step_), { date: hasDate && stepDate ? stepDate : null, checklist: hasChecklist && stepChecklist ? stepChecklist : [], uploadedFile: hasUpload && stepUploadedFile && stepUploadedFile.url
                                        ? stepUploadedFile
                                        : null });
                            }
                        }
                        step_.isForm =
                            step_.devName.toLowerCase().includes("fill") &&
                                ...
                                : false;
                        if (step_.isForm) {
                            if (step_.devName == "sponsorFillCoordinatorForm" ||
                                step_.devName == "schoolFillCoordinatorForm")
                                step_.type = 2;
                            else if (step_.devName == "coordinatorFillSponsorForm" ||
                        ...
                        switch (step_.tag) {
                            case "2":
                                ...
                                if (ind2 >= 0)
                                    this.coordinatorSteps[ind2] = step_;
                                else
    ...
    callStates() {
        if (!this.statesLoaded)
            this.subscription.add(this.stepsService.getStates().subscribe(({ records: res }) => {
                this.theStates = null;
                setTimeout(() => {
                    this.theStates = res;
    ...
    updateSteps(p_i) {
        this.store.dispatch(new _store_actions_steps_project_actions__WEBPACK_IMPORTED_MODULE_8__["UpdateStepsProgress"](p_i)).subscribe((res) => {
            this.enabledTabs = true;
        });
    }
    switchStep(num, e) {
...
StepsComponent.propDecorators = {
    generalStepsRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChildren"], args: ["generalStep", { read: _general_steps_general_steps_component__WEBPACK_IMPORTED_MODULE_11__["GeneralStepsComponent"] },] }]
};
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_4__["Select"])(_store_states_e_learning_user_state__WEBPACK_IMPORTED_MODULE_6__["UserState"].user_projects)
], StepsComponent.prototype, "userProjects$", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_4__["Select"])(_store_states_e_learning_user_state__WEBPACK_IMPORTED_MODULE_6__["UserState"].user_type)
], StepsComponent.prototype, "user_type$", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_4__["Select"])(_store_states_e_learning_user_state__WEBPACK_IMPORTED_MODULE_6__["UserState"].user_id)
], StepsComponent.prototype, "user_id$", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_4__["Select"])(_store_states_steps_project_state__WEBPACK_IMPORTED_MODULE_9__["StepsState"].selected_proj_id)
], StepsComponent.prototype, "selected_project_id$", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_4__["Select"])(_store_states_steps_project_state__WEBPACK_IMPORTED_MODULE_9__["StepsState"].all_needed)
], StepsComponent.prototype, "project_steps$", void 0);
...
/* harmony import */ var _steps_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./steps-routing.module */ "SpLn");
/* harmony import */ var _steps_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./steps.component */ "AmIL");
/* harmony import */ var _general_steps_general_steps_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./general-steps/general-steps.component */ "r9gT");
/* harmony import */ var _steps_forms_steps_forms_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./steps-forms/steps-forms.component */ "ZiER");
...
/* harmony import */ var _nguniversal_common__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @nguniversal/common */ "zlXd");
/* harmony import */ var ng2_datepicker__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ng2-datepicker */ "gF1S");
/* harmony import */ var ng2_datepicker__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(ng2_datepicker__WEBPACK_IMPORTED_MODULE_12__);
...
StepsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _steps_component__WEBPACK_IMPORTED_MODULE_5__["StepsComponent"],
            _general_steps_general_steps_component__WEBPACK_IMPORTED_MODULE_6__["GeneralStepsComponent"],
            _general_steps_general_steps_component__WEBPACK_IMPORTED_MODULE_6__["StatusSelectorComponent"],
            _steps_forms_steps_forms_component__WEBPACK_IMPORTED_MODULE_7__["StepsFormsComponent"],
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _steps_routing_module__WEBPACK_IMPORTED_MODULE_4__["StepsRoutingModule"],
            _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormsModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"],
            _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_8__["NgSelectModule"],
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_10__["BrowserTransferStateModule"],
            _nguniversal_common__WEBPACK_IMPORTED_MODULE_11__["TransferHttpCacheModule"],
            ng2_datepicker__WEBPACK_IMPORTED_MODULE_12__["NgDatepickerModule"]
        ]
    })
], StepsModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StepsRoutingModule", function() { return StepsRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "iInd");
/* harmony import */ var _steps_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./steps.component */ "AmIL");
...
let StepsRoutingModule = class StepsRoutingModule {
};
StepsRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EMAIL_PTTRN", function() { return EMAIL_PTTRN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LETTERS_PTTRN", function() { return LETTERS_PTTRN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LETTERS_NUMBERS_PTTRN", function() { return LETTERS_NUMBERS_PTTRN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TEXT_PTTRN", function() { return TEXT_PTTRN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NUMBER_PTTRN", function() { return NUMBER_PTTRN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VIDEO_PTTRN", function() { return VIDEO_PTTRN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StepsFormsComponent", function() { return StepsFormsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_steps_forms_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./steps-forms.component.html */ "tZxA");
/* harmony import */ var _steps_forms_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./steps-forms.component.scss */ "E2Xt");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "8Y7J");
...
/* harmony import */ var _services_steps_steps_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../services/steps/steps.service */ "OR82");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs */ "qCKp");
...
const EMAIL_PTTRN = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/;
const LETTERS_PTTRN = /^[a-z A-Zá-úÁ-Ú]*$/;
const LETTERS_NUMBERS_PTTRN = "^[a-z A-Zá-úÁ-Ú0-9]*$";
const TEXT_PTTRN = /^[a-z A-Zá-úÁ-Ú0-9._~:/?#\[\]@!\$&'"\(\)\*\+,;=]*$/;
const NUMBER_PTTRN = /^[0-9]*$/;
const VIDEO_PTTRN = /^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&'\(\)\*\+,;=.]+$/;
let StepsFormsComponent = class StepsFormsComponent {
    constructor(fb, stepsService, globals) {
        this.fb = fb;
        this.stepsService = stepsService;
        ...
        this.sponsorForm = this.fb.group({
            ...
            email: [
                "",
                [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(EMAIL_PTTRN)],
            ],
            rif: [
                "",
                [
                    ...
                    _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(NUMBER_PTTRN),
                ],
            ],
            ...
            contactFirstName: [
                "",
                [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(LETTERS_PTTRN)],
            ],
            contactLastName: [
                "",
                [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(LETTERS_PTTRN)],
        ...
        this.schoolForm = this.fb.group({
            ...
            code: [
                "",
                [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(LETTERS_NUMBERS_PTTRN)],
            ],
            addressState: ["", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]],
            addressMunicipality: ["", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]],
            addressStreet: ["", [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]],
            ...
            principalEmail: [
                "",
                [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(EMAIL_PTTRN)],
            ],
            principalPhone: [
                "",
                [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(NUMBER_PTTRN)],
            ],
            //
    ...
    ngOnInit() {
        ...
        if (this.who === "coordinator") {
            this.subscription.add(this.coordinatorForm.get("cardType").statusChanges.subscribe((res) => {
                this.setLength("cardId", "cardType");
            }));
        }
        if (this.who === "sponsor") {
            this.subscription.add(this.sponsorForm.get("companyType").statusChanges.subscribe((res) => {
                if (this.sponsorForm.get("companyType").value &&
                    this.sponsorForm.get("companyType").value === "0") {
                    this.sponsorForm.setControl("companyOtherType", this.fb.control(this.sponsorForm.get("companyOtherType").value, [
                        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
                        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(LETTERS_PTTRN),
                    ]));
                    this.disableOther = false;
                }
                else {
                    this.sponsorForm.setControl("companyOtherType", this.fb.control(this.sponsorForm.get("companyOtherType").value, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(LETTERS_PTTRN)));
        ...
        this.fillForm();
        if (this.who === "school") {
            this.subscription.add(this.schoolForm.get("name").statusChanges.subscribe((res) => {
            ...
            this.subscription.add(this.schoolForm
                .get("addressMunicipality")
                .statusChanges.subscribe((res) => {
                if (this.schoolForm.get("addressMunicipality").value &&
    ...
    fillMunicipalities(state_id = "default", munId = "") {
        if (this.setMuns && this.setMuns.length > 0) {
            if (state_id == "default")
                ...
                this.municipalitiesData = this.setMuns.filter((m) => {
                    return m.state.id == state_id;
                });
            }
            if (this.who == "sponsor")
                this.sponsorForm.patchValue({ addressMunicipality: munId });
            else if (this.who == "coordinator")
                this.coordinatorForm.patchValue({ addressMunicipality: munId });
            else if (this.who == "school")
                this.schoolForm.patchValue({ addressMunicipality: munId });
        }
    }
    updateMuns(findMunId = false) {
        ...
        if (this.who == "sponsor") {
            currStateId =
                this.sponsorForm.controls["addressState"].value &&
                    this.sponsorForm.controls["addressState"].value.length > 0
                    ? this.sponsorForm.controls["addressState"].value
                    : "default";
            if (findMunId)
                currMunId =
                    this.sponsorForm.controls["addressMunicipality"].value &&
                        this.sponsorForm.controls["addressMunicipality"].value.length > 0
                        ? this.sponsorForm.controls["addressMunicipality"].value
                        : "";
        }
        else if (this.who == "coordinator") {
            currStateId =
                this.coordinatorForm.controls["addressState"].value &&
                    this.coordinatorForm.controls["addressState"].value.length > 0
                    ? this.coordinatorForm.controls["addressState"].value
                    : "default";
            if (findMunId)
                currMunId =
                    this.coordinatorForm.controls["addressMunicipality"].value &&
                        this.coordinatorForm.controls["addressMunicipality"].value.length > 0
                        ? this.coordinatorForm.controls["addressMunicipality"].value
                        : "";
        }
        else if (this.who == "school") {
            currStateId =
                this.schoolForm.controls["addressState"].value &&
                    this.schoolForm.controls["addressState"].value.length > 0
                    ? this.schoolForm.controls["addressState"].value
                    : "default";
            if (findMunId)
                currMunId =
                    this.schoolForm.controls["addressMunicipality"].value &&
                        this.schoolForm.controls["addressMunicipality"].value.length > 0
                        ? this.schoolForm.controls["addressMunicipality"].value
                        : "";
        }
        if (findMunId)
            this.fillMunicipalities(currStateId, currMunId);
        else
    ...
    onSubmitschool(fo) {
        ...
        const solicitudBodyReduced = Object.keys(this.schoolForm.value).reduce((solicitudBody, controlName) => {
            if (controlName === "addressStreet")
                ...
                solicitudBody[controlName] =
                    this.schoolForm.controls[controlName].value.length > 0
                        ? this.schoolForm.controls[controlName].value
                        : null;
            else if (controlName === "nTeachers" ||
                ...
                solicitudBody[controlName] =
                    (controlName === "code" &&
                        typeof this.schoolForm.controls[controlName].value === "string" &&
                        this.schoolForm.controls[controlName].value.replace(/\s/g, "")) ||
                        this.schoolForm.controls[controlName].value;
            return solicitudBody;
        }, {
            user: this.user_id,
    ...
    postForm(solicitudBody, fo, type) {
        this.stepsService.requestsFind(type, solicitudBody).subscribe((res) => {
            ...
            let errorType = error.error && error.error["code"]
                ? "code"
            ...
            switch (type) {
                case 1:
                    if (errorType != "regular")
                        this.sponsorForm.get("email").setValue("");
                    break;
                case 2:
                    if (errorType != "regular")
                        this.coordinatorForm.get("email").setValue("");
                    break;
                default:
                    if (errorType != "regular")
                        this.schoolForm.get(errorType).setValue("");
                    break;
            }
    ...
    validate(op) {
        if (!this.disableThis()) {
            switch (this.who) {
                case "sponsor":
                    return this.sponsorForm.controls[op].status === "INVALID" &&
                        this.sponsorForm.controls[op].dirty
                        ? true
                        : false;
                case "coordinator":
                    return this.coordinatorForm.controls[op].status === "INVALID" &&
                        this.coordinatorForm.controls[op].dirty
                        ? true
                        : false;
                case "school":
                    return this.schoolForm.controls[op].status === "INVALID" &&
                        this.schoolForm.controls[op].dirty
                        ? true
                        : false;
            }
        }
    ...
    isEmpty(op) {
        if (!this.disableThis()) {
            switch (this.who) {
                case "sponsor":
                    return !this.sponsorForm.controls[op].value ||
                        this.sponsorForm.controls[op].value === ""
                        ? false
                        : true;
                case "coordinator":
                    return !this.coordinatorForm.controls[op].value ||
                        this.coordinatorForm.controls[op].value === ""
                        ? false
                        : true;
                case "school":
                    return !this.schoolForm.controls[op].value ||
                        this.schoolForm.controls[op].value === ""
                        ? false
                        : true;
            }
        }
    ...
    fillSchool(res) {
        this.schoolForm.setValue({
            ...
            subPrincipalFirstName: res.subPrincipalFirstName
                ? res.subPrincipalFirstName
                : "",
            subPrincipalLastName: res.subPrincipalLastName
                ? res.subPrincipalLastName
                : "",
        ...
        if (res.coordinate && this.globals.isBrowser) {
            const initMap = () => {
                if (google) {
                    ...
                    setTimeout(() => {
                        if (this.schoolmap) {
                            this.mapSettings(res.coordinate.latitude, res.coordinate.longitude, 11);
                            this.mapInitializer(true);
                            this.loadAllMarkers({
                                name: res.name,
    ...
    setMaxLen(controlName) {
        const ct = this[this.who === "coordinator" ? "coordinatorForm" : "sponsorForm"].get(controlName).value; // 1: V, 2: J, 3: E
        return ct === "1" ? 8 : 9;
    }
    setMinLen(controlName) {
        const ct = this[this.who === "coordinator" ? "coordinatorForm" : "sponsorForm"].get(controlName).value; // 1: V, 2: J, 3: E
        return ct === "1" ? 7 : ct === "2" ? 8 : 9;
    }
    setLength(controlName, controlCardType) {
        this[this.who === "coordinator" ? "coordinatorForm" : "sponsorForm"].setControl(controlName, this.fb.control(this[this.who === "coordinator" ? "coordinatorForm" : "sponsorForm"].get(controlName).value, [
            _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required,
            _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(this.setMinLen(controlCardType)),
            _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(this.setMaxLen(controlCardType)),
            _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(NUMBER_PTTRN),
        ]));
    ...
    isMaxLenOver(controlName, controlCardType) {
        const ctrlNameVal = this[this.who === "coordinator" ? "coordinatorForm" : "sponsorForm"]
    ...
    isMinLenUnder(controlName, controlCardType) {
        const ctrlNameVal = this[this.who === "coordinator" ? "coordinatorForm" : "sponsorForm"]
            .controls[controlName].value;
        if (ctrlNameVal)
    ...
    hasMaxOrMin(controlName, controlCardType) {
        return (this.isMaxLenOver(controlName, controlCardType) ||
            this.isMinLenUnder(controlName, controlCardType));
    }
};
StepsFormsComponent.ctorParameters = () => [
...
StepsFormsComponent.propDecorators = {
    schoolmap: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ["schoolAddressMap", { read: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ElementRef"], static: false },] }],
    who: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    disable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    setStates: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    setMuns: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    ...
    project_id: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    user_id: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    approvalHistory: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    emitMessage: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
    emitUpdate: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }]
};
StepsFormsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GeneralStepsComponent", function() { return GeneralStepsComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatusSelectorComponent", function() { return StatusSelectorComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_general_steps_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./general-steps.component.html */ "LfC0");
/* harmony import */ var _general_steps_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./general-steps.component.scss */ "BQR6");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "SVse");
/* harmony import */ var ngx_embed_video__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-embed-video */ "RXmf");
...
/* harmony import */ var _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @fortawesome/free-solid-svg-icons */ "EcpT");
...
/* harmony import */ var _services_steps_steps_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../services/steps/steps.service */ "OR82");
...
/* harmony import */ var _steps_forms_steps_forms_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../steps-forms/steps-forms.component */ "ZiER");
...
let GeneralStepsComponent = class GeneralStepsComponent {
    constructor(platformId, embedService, sanitizer, stepsService, globals) {
    ...
    showConditioned(step) {
        ...
        return (step.devName != "findCoordinator" &&
    ...
    getVideo(url, stepId) {
        if (this.showThisVideo && this.timesVideoSourceCalled < 10) {
            ...
            if (video)
                this.timesVideoSourceCalled++;
            if (!this.video_[stepId])
                this.video_[stepId] = video;
            return this.video_[stepId];
        }
        else if (this.video_[stepId])
            return this.video_[stepId];
    }
    sanitizeFile(url) {
    ...
    enableChecksBtn(step, bool = false) {
        let enable = bool;
    ...
    approvalMethod(step, indd, modd, status) {
        step.sending = true;
        ...
        let getPosting = () => {
            ...
            if (step.hasUpload &&
                ...
                formData.append(step.approvalType == "3" ? "stepUploadedFile" : "uploadedFile", step.uploadedFile.file);
            if (step.hasChecklist)
                formData.append(step.approvalType == "3" ? "stepChecklist" : "checklist", JSON.stringify(step.checklist));
        };
        if ((step.status == "1" &&
            ...
            // approval request
                ...
                this.postSA(formData, step, indd, modd, this.project_id); // step approval
        }
        else {
            // when a register of this approval request already exists
            let rqstApv = step.approvalHistory.length > 0
            ...
            if ((step.hasUpload && (rqstApv == "3" || rqstApv == "4")) ||
                ...
                this.putAR(formData, step, indd, modd, step.approvalHistory[step.approvalHistory.length - 1].id);
        }
    }
    ...
    postAR(formData, step, indd, modd) {
    ...
    postSA(formData, step, indd, modd, proj_id) {
    ...
    putAR(formData, step, indd, modd, id) {
        ...
        this.stepsService
            ...
            if (step.status == "1")
                ...
                step.status = "1"; // this is not reached by checklist btn
            this.updatingEmitting(step, indd, modd);
        }, (error) => {
            const error_msg = error.error && error.error instanceof ProgressEvent
                ? "Puede que tenga problemas con su conexión a internet, verifique e intente nuevamente"
    ...
    showSeveralsButton(step) {
        return ((step.hasChecklist && step.hasDate && step.hasUpload) ||
    ...
    disableSeveralsButton(step) {
        ...
        if (step.hasDate && step.hasUpload)
            return !step.date || !step.uploadedFile;
        if (!step.hasChecklist && step.hasDate && !step.hasUpload)
            return !step.date;
        return false;
    }
...
GeneralStepsComponent.ctorParameters = () => [
...
GeneralStepsComponent.propDecorators = {
    stepFormTemplateRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChildren"], args: ["stepFormTemplate", { read: _steps_forms_steps_forms_component__WEBPACK_IMPORTED_MODULE_11__["StepsFormsComponent"] },] }],
    mode: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    steps: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    curriculumPending: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    user_type: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    user_id: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    project_id: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    confirmable: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    enableActions: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    setStates: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    setMuns: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    callUpdate: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }]
};
GeneralStepsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
...
let StatusSelectorComponent = class StatusSelectorComponent {
    constructor(fb) {
        this.fb = fb;
...
StatusSelectorComponent.ctorParameters = () => [
...
StatusSelectorComponent.propDecorators = {
    ...
    index: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    mode: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    isReadOnly: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
    approvalMethodCallerEmitter: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }]
};
StatusSelectorComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
