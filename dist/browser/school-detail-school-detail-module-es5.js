(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["school-detail-school-detail-module"], {
    ...
    /***/
    function Df1L(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SchoolDetailComponent", function () {
      ...
      var _raw_loader_school_detail_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./school-detail.component.html */
      "4zW6");
      /* harmony import */


      var _school_detail_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var src_app_services_web_school_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/services/web/school.service */
      "Nq1u");
      /* harmony import */
      ...
      var src_app_services_web_chart_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/services/web/chart.service */
      "RUPo");
      /* harmony import */
      ...
      var SchoolDetailComponent = /*#__PURE__*/function () {
        function SchoolDetailComponent(router, route, globalService, staticSchoolService, chartService, zone, store, http) {
          var _responsive4, _activities;
          ...
          this.schoolImagesOptions = Object.assign(Object.assign({}, this.carouselOptions), {
            responsive: {
              0: {
                items: 1
              }
          ...
          this.activitiesIndexOptions = Object.assign(Object.assign({}, this.carouselOptions), {
            loop: false,
          ...
          this.activityImagesOptions = Object.assign(Object.assign({}, this.carouselOptions), {
            center: true,
            loop: true,
            nav: false,
            //autoWidth:true,
          ...
          this.teachersOptions = Object.assign(Object.assign({}, this.carouselOptions), {
            responsive: _defineProperty({
              0: {
                items: 2
              }
          ...
          this.activitiesOptions = Object.assign(Object.assign({}, this.carouselOptions), {
            loop: false,
            responsive: (_responsive4 = {
              0: {
                items: this.landscape ? 3 : 1
              }
            }, _defineProperty(_responsive4, 768, {
              items: 3
            }), _defineProperty(_responsive4, 1024, {
              items: 4
            }), _responsive4)
          });
          this.otherSchoolsOptions = Object.assign(Object.assign({}, this.carouselOptions), {
            loop: false,
            mouseDrag: false,
            touchDrag: false,
            nav: false,
          ...
          this.school = {
            ...
            activities: (_activities = {}, _defineProperty(_activities, this.ACTIVITIES.WITH_TEACHERS, []), _defineProperty(_activities, this.ACTIVITIES.SPECIALS, []), _activities),
            activitiesSlider: [],
            testimonials: [],
            nextActivities: [],
            otherSchools: [],
        ...
        _createClass(SchoolDetailComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.paramMap.subscribe(function (params) {
              _this.slug = params.get('schoolSlug');
              if (_this.school && _this.school.charts) _this.school.charts = [];

              _this.setApiService(params.get('schoolSlug'));

              _this.getSchoolDetail();
            });
            this.routerSubscription = this.router.events.subscribe(function (event) {
              if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_5__["NavigationEnd"]) {
                _this.renavigateToTop();

                _this.reinitCarousels();

                _this.chartSwitcher.switchChart(1);
              }
            });
          }
        }, {
          ...
          key: "getSchoolDetail",
          value: function getSchoolDetail() {
            var _this2 = this;
            ...
            this.schoolService.getWebContent().subscribe(function (data) {
              ...
              _this2.school = {
                ...
                activities: (_activities2 = {}, _defineProperty(_activities2, _this2.ACTIVITIES.WITH_TEACHERS, []), _defineProperty(_activities2, _this2.ACTIVITIES.SPECIALS, data.activities), _activities2),
                activitiesSlider: data.activitiesSlider,
                testimonials: data.teachersTestimonials.testimonials.map(function (testimonial) {
                  testimonial["function"] = testimonial.position;
                  return testimonial;
                }),
                nextActivities: data.nextActivities.reduce(function (activities, activity) {
                  var _map = [new Date(), new Date(activity.date)].map(function (date_) {
                    return date_.toISOString().toLowerCase().split('t')[0];
                  }),
                      _map2 = _slicedToArray(_map, 2),
                      now = _map2[0],
                      actDate = _map2[1];

                  var canPush = new Date(actDate) >= new Date(now);

                  if (canPush) {
                    var theActivity = Object.assign(Object.assign({}, activity), {
                      title: activity.name,
                      date: _this2.pipe.transform(Date.parse(activity.date), 'd/M/y')
                    });
                ...
                otherSchools: data.nearbySchools.map(function (school) {
              ...
              _this2.staticSchoolService.getChartsTemplateJSON().subscribe(function (charts) {
                _this2.school.charts = charts.map(function (chart) {
                  chart.data = data.diagnostics[chart.id];
                  return chart;
                });
                _this2.chartSwitcherOptions.charts = _this2.chartService.formatChartDataToDrawComponent(_this2.school.charts);
              });

              setTimeout(function () {
                _this2.school.images = data.slider;
              });

              _this2.reinitCarousels();

              _this2.chartSwitcher && _this2.chartSwitcher.switchChart(0);

              _this2.setActiveChart(0);
          ...
          key: "scrollToPage",
          value: function scrollToPage() {
            var schoolTopPos = this.schoolSection.nativeElement.offsetTop;
            window.scrollTo(0, schoolTopPos);
          }
        }, {
          key: "renavigateToTop",
          value: function renavigateToTop() {
            var _this3 = this;
          ...
          value: function subscribeScrollEvent() {
            ...
            this.zone.runOutsideAngular(function () {
              _this4.scrollSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_12__["fromEvent"])(window, 'scroll').subscribe(function (event) {
                _this4.onScroll(event);
              });
            });
          }
        }, {
          ...
          value: function onScroll($event) {
            var scrollPosition = $event.srcElement.children[0].scrollTop + window.innerHeight;
            var symbolsPosition = this.symbols.nativeElement.offsetTop;
            var chartsPosition = this.charts.nativeElement.offsetTop;
          ...
          key: "setActiveChart",
          value: function setActiveChart(index) {
            this.activeChartIndex = index;
          }
        }, {
          key: "setActivitiesType",
          value: function setActivitiesType(type) {
          ...
          key: "setActiveActivity",
          value: function setActiveActivity(index) {
            try {
              this.activeActivityIndex = index; //this.activityImageCarousel.reInit();
            } catch (error) {
              console.error(error);
            }
          }
          ...
          key: "setApiService",
          value: function setApiService(slug) {
            ...
            service.setResourcePath("".concat(this.SCHOOLS_PATH, "/").concat(slug));
          ...
          key: "reinitCarousels",
          value: function reinitCarousels() {
      ...
      SchoolDetailComponent.ctorParameters = function () {
        return [{
      ...
      SchoolDetailComponent.propDecorators = {
        ...
        activitiesIndexCarousel: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"],
          args: ['activitiesIndexCarousel', {
            "static": true
          }]
        }],
        activityImageCarousel: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"],
          args: ['activityImageCarousel', {
            "static": false
          }]
        }],
        activitiesCarousel: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"],
          args: ['activitiesCarousel', {
            "static": true
          }]
        }],
        otherSchoolsCarousel: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"],
          args: ['otherSchoolsCarousel', {
            "static": true
          }]
        }],
        charts: [{
      ...
      SchoolDetailComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function Nq1u(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var schoolsList = {
        schools: [{
          ...
          images: ['./assets/images/banner-1.jpg', './assets/images/banner-2.jpg', './assets/images/banner-1.jpg', './assets/images/banner-2.jpg'],
          charts: [{
            title: 'Diagnóstico de Lectura',
            description: diagnosticText.lecture,
            type: 'bar',
          ...
          activities: {
            withTeachers: [{
              ...
              images: ['./assets/images/banner-1.jpg', './assets/images/banner-2.jpg', './assets/images/background-pillar-lectura.jpg', './assets/images/background-pillar-ambiente.jpg', './assets/images/background-pillar-matematica.jpg']
            }, {
              name: 'Actividad 2',
      ...
      var SchoolService = /*#__PURE__*/function () {
        ...
        _createClass(SchoolService, [{
          key: "getSchoolsJSON",
          value: function getSchoolsJSON() {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(schoolsList);
          }
        }, {
          key: "getSchoolBySlugJSON",
          value: function getSchoolBySlugJSON(slug) {
            var school;
            school = schoolsList.schools.filter(function (item) {
              return item.slug === slug;
            })[0];
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(school);
          }
        }, {
          key: "getChartsTemplateJSON",
          value: function getChartsTemplateJSON() {
      ...
      SchoolService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], SchoolService);
      /***/
    },
    ...
    /***/
    function f0pY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SchoolDetailModule", function () {
      ...
      var _school_detail_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./school-detail-routing.module */
      "wc80");
      /* harmony import */


      var _school_detail_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var src_app_web_shared_shared_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/web/shared/shared.module */
      "vYfc");
      /* harmony import */
      ...
      var src_app_web_shared_charts_switcher_charts_switcher_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/web/shared/charts-switcher/charts-switcher.module */
      "w52O");
      /* harmony import */
      ...
      var SchoolDetailModule = /*#__PURE__*/_createClass(function SchoolDetailModule() {
        _classCallCheck(this, SchoolDetailModule);
      });

      SchoolDetailModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_school_detail_component__WEBPACK_IMPORTED_MODULE_4__["SchoolDetailComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _school_detail_routing_module__WEBPACK_IMPORTED_MODULE_3__["SchoolDetailRoutingModule"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_5__["CarouselModule"], ngx_owl_carousel__WEBPACK_IMPORTED_MODULE_7__["OwlModule"], src_app_web_shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], src_app_web_shared_charts_switcher_charts_switcher_module__WEBPACK_IMPORTED_MODULE_8__["ChartsSwitcherModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_9__["FontAwesomeModule"]]
      })], SchoolDetailModule);
      /***/
    },
    ...
    /***/
    function wc80(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SchoolDetailRoutingModule", function () {
        return SchoolDetailRoutingModule;
      });
      /* harmony import */
      ...
      var _school_detail_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./school-detail.component */
      "Df1L");
      ...
      var SchoolDetailRoutingModule = /*#__PURE__*/_createClass(function SchoolDetailRoutingModule() {
        _classCallCheck(this, SchoolDetailRoutingModule);
      });

      SchoolDetailRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=school-detail-school-detail-module-es5.js.map