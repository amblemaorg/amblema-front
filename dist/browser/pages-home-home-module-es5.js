(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-home-home-module"], {
    ...
    /***/
    function m3S(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JNK3(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "HOME_CONTENT", function () {
        return HOME_CONTENT;
      });
    ...
    /***/
    function NXFh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_services_web_chart_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var _home_static_content__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./home-static-content */
      "JNK3");
      /* harmony import */
      ...
      var src_app_services_web_api_web_content_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var _web_pages_metadata__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ../../web-pages-metadata */
      "Xkmw");
      /* harmony import */


      var src_app_store_actions_web_web_actions__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! src/app/store/actions/web/web.actions */
      "LMpb");
      /* harmony import */


      var _ngxs_store__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! @ngxs/store */
      "e1JD");

      var HomeComponent = /*#__PURE__*/function () {
        function HomeComponent(globalService, chartService, modalService, http, zone, iconService, store) {
        ...
        _createClass(HomeComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.isBrowser = this.globalService.isBrowser; //this.setStaticService();

            this.setApiService();
            this.getHomePageData();
            this.zone.runOutsideAngular(function () {
              _this2.scrollSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_12__["fromEvent"])(window, "scroll").subscribe(function (event) {
          ...
          value: function setApiService() {
            var service = new src_app_services_web_api_web_content_service__WEBPACK_IMPORTED_MODULE_11__["ApiWebContentService"](this.http);
          ...
          value: function getHomePageData() {
            ...
            this.homeService.getWebContent().subscribe(function (data) {
              ...
              _this3.coverData.slider = data.homePage.slider.map(function (slide) {
                return {
                  image: slide.image,
                  title: slide.description
                };
              });
              _this3.finalStatistics = {
              ...
              var chartsData = _home_static_content__WEBPACK_IMPORTED_MODULE_9__["HOME_CONTENT"].homePage.statistics.charts;
              chartsData.map(function (chart) {
                chart.data = data.homePage.diagnostics[chart.id].map(function (lapse) {
                  if (lapse.value == 0) lapse.value = 0.00;
                  return lapse;
                });
                chart.data.map(function (element) {
                  element.value = element.value > 0 && element.value < 1 ? parseFloat((element.value * 100).toFixed(2)) : parseFloat(element.value.toFixed(2));
                });
                return chart.data;
              });
              _this3.homePageData = data.homePage;
              _this3.chartSwitcherOptions.charts = _this3.chartService.formatChartDataToDrawComponent(chartsData);

              _this3.store.dispatch([new src_app_store_actions_web_web_actions__WEBPACK_IMPORTED_MODULE_15__["SetIsLoadingPage"](false)]);
            });
          }
        }, {
          key: "onScroll",
          value: function onScroll($event) {
            ...
            var leafPosition = this.leaf.nativeElement.offsetTop;
            var listElementPosition = this.pillarsList.nativeElement.offsetTop;
            var statisticsPosition = this.statistics.nativeElement.offsetTop;
          ...
          key: "openModal",
          value: function openModal(pillar, content) {
            this.selectedPillar = this.getPillar(pillar);
            this.modalService.openModal(content);
          }
        }, {
          key: "getPillar",
          value: function getPillar(pillarName) {
            switch (pillarName) {
              case "environment":
                return {
                  title: "Ambiente",
              ...
              case "math":
                return {
                  title: "Matemática",
                  description: this.homePageData.mathText
                };

              case "reading":
                return {
                  title: "Lectura",
                  description: this.homePageData.readingText
                };
          ...
          key: "commaRemover",
          value: function commaRemover(leNumero) {
            return "".concat(leNumero).replace(/,/g, ".");
          }
        }, {
          key: "onResize",
          value: function onResize() {
            if (window.innerWidth < 768 && window.innerWidth < window.innerHeight) this.pillarsCarousel.refresh();
          }
        }]);
    ...
    /***/
    function WGsg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function sVHQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _shared_charts_switcher_charts_switcher_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../shared/charts-switcher/charts-switcher.module */
      "w52O");
      /* harmony import */
      ...
      HomeModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_5__["HomeRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_4__["CarouselModule"], ngx_owl_carousel__WEBPACK_IMPORTED_MODULE_7__["OwlModule"], _shared_charts_switcher_charts_switcher_module__WEBPACK_IMPORTED_MODULE_8__["ChartsSwitcherModule"], angular_svg_icon__WEBPACK_IMPORTED_MODULE_10__["AngularSvgIconModule"], angular2_counto__WEBPACK_IMPORTED_MODULE_9__["CountoModule"]]
      })], HomeModule);
      /***/
    }
  }]);
