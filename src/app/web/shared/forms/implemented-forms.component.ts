...
export class ImplementedFormsComponent implements OnInit {
  ...
  schoolStep3 = {
    ...
    schoolType: { label: "Tipo de escuela", ...this.controlProps.select,
      options: [
        { id: '1', name: 'Nacional' }, { id: '2', name: 'Estadal' }, { id: '3', name: 'Municipal' }
      ]
    },
    schoolShift: { label: "Turno de clases", ...this.controlProps.select,
      options: [
        { id: '1', name: 'Mañana' }, { id: '2', name: 'Tarde' }, { id: '3', name: 'Ambos' }
      ]
    },
  }
  ...
  sponsorStep2 = {
    companyType: { label: "Tipo de Empresa", ...this.controlProps.select,
      options: [
        { id: '1', name: 'Fábrica'          },
        { id: '2', name: 'Tienda'           },
  ...
  coordinatorStep2 = {
    ...
    isReferred:  { label: "¿Es referido de álguien?", ...this.controlProps.select,
      options: [
        { id: true, name: 'Sí' }, { id: false, name: 'No' }
      ]
    },
    referredName: {
  ...
  getMunicipalitiesData() {
    this.contactService.getMunicipalities()
        .subscribe(data => {
