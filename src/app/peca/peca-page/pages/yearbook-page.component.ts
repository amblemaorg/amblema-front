              ...
              if (isInApproval || yearbookHasNotApprovedRequest) {
                ...
                newYearBook = {
                  ...
                  sponsor: {
                    ...
                    image: /* (this.ybData && this.ybData.sponsor.image && this.ybData.sponsor.image.length ? this.ybData.sponsor.image : false) ||  */lastYearBookRequest.sponsor.image,
                    content: /* (this.ybData && this.ybData.sponsor.content && this.ybData.sponsor.content.length ? this.ybData.sponsor.content : false) ||  */lastYearBookRequest.sponsor.content,
                  },
                  coordinator: {
                    ...currentYearBook.coordinator,
                    image: /* (this.ybData && this.ybData.coordinator.image && this.ybData.coordinator.image.length ? this.ybData.coordinator.image : false) ||  */lastYearBookRequest.coordinator.image,
                    content: /* (this.ybData && this.ybData.coordinator.content && this.ybData.coordinator.content.length ? this.ybData.coordinator.content : false) ||  */lastYearBookRequest.coordinator.content,
                  },
                  school: {
                    ...currentYearBook.school,
                    image: /* (this.ybData && this.ybData.school.image && this.ybData.school.image.length ? this.ybData.school.image : false) ||  */lastYearBookRequest.school.image,
                    content: /* (this.ybData && this.ybData.school.content && this.ybData.school.content.length ? this.ybData.school.content : false) ||  */lastYearBookRequest.school.content,
                  },
                  historicalReview: {
                    ...currentYearBook.historicalReview,
                    name: lastYearBookRequest.historicalReview.name,
                    image: /* (this.ybData && this.ybData.historicalReview.image && this.ybData.historicalReview.image.length ? this.ybData.historicalReview.image : false) ||  */lastYearBookRequest.historicalReview.image,
                    content: /* (this.ybData && this.ybData.historicalReview.content && this.ybData.historicalReview.content.length ? this.ybData.historicalReview.content : false) ||  */lastYearBookRequest.historicalReview.content,
                  },
                  lapse1: {
                    ...
                    activities: currentYearBook.lapse1.activities.map((activity) => {
                      ...
                      const descriptionReturnValue = activityRequested.length > 0 ? activityRequested[0].description : "";
                    ...
                    logicDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse1.logicDiagnosticAnalysis && this.ybData.lapse1.logicDiagnosticAnalysis.length ? this.ybData.lapse1.logicDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse1.logicDiagnosticAnalysis,
                    mathDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse1.mathDiagnosticAnalysis && this.ybData.lapse1.mathDiagnosticAnalysis.length ? this.ybData.lapse1.mathDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse1.mathDiagnosticAnalysis,
                    readingDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse1.readingDiagnosticAnalysis && this.ybData.lapse1.readingDiagnosticAnalysis.length ? this.ybData.lapse1.readingDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse1.readingDiagnosticAnalysis,
                  },
                  lapse2: {
                    ...
                    logicDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse2.logicDiagnosticAnalysis && this.ybData.lapse2.logicDiagnosticAnalysis.length ? this.ybData.lapse2.logicDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse2.logicDiagnosticAnalysis,
                    mathDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse2.mathDiagnosticAnalysis && this.ybData.lapse2.mathDiagnosticAnalysis.length ? this.ybData.lapse2.mathDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse2.mathDiagnosticAnalysis,
                    readingDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse2.readingDiagnosticAnalysis && this.ybData.lapse2.readingDiagnosticAnalysis.length ? this.ybData.lapse2.readingDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse2.readingDiagnosticAnalysis,
                  },
                  lapse3: {
                    ...
                    logicDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse3.logicDiagnosticAnalysis && this.ybData.lapse3.logicDiagnosticAnalysis.length ? this.ybData.lapse3.logicDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse3.logicDiagnosticAnalysis,
                    mathDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse3.mathDiagnosticAnalysis && this.ybData.lapse3.mathDiagnosticAnalysis.length ? this.ybData.lapse3.mathDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse3.mathDiagnosticAnalysis,
                    readingDiagnosticAnalysis: /* (this.ybData && this.ybData.lapse3.readingDiagnosticAnalysis && this.ybData.lapse3.readingDiagnosticAnalysis.length ? this.ybData.lapse3.readingDiagnosticAnalysis : false) ||  */lastYearBookRequest.lapse3.readingDiagnosticAnalysis,
                  },
